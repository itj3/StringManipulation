...
public class PalindromeUI extends javax.swing.JFrame {

    /**
     * Creates new form PalindromeUI
     */
    public PalindromeUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("This app checks for palindromes.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //grab input from jTextField1
        String input = jTextField1.getText();
        Palindrome pal = new Palindrome();
        boolean is_pal = pal.isPalindrome(input);
        String output;
        if(is_pal){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalindromeUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalindromeUI().setVisible(true);
            }
        });
    }
